...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_POST['submit'])) {   
        ...
        $sql = mysqli_query($con, "INSERT INTO tblpatient(Docid, PatientName, PatientContno, PatientEmail, PatientGender, PatientAdd, PatientAge, PatientMedhis, service) VALUES('$docid', '$patname', '$patcontact', '$patemail', '$gender', '$pataddress', '$patage', '$medhis', '$service')");
        ...
        if ($sql) {
            ...
            $sql_queue = mysqli_query($con, "INSERT INTO patient_ques(name, queue_number, queue_date, status, service) VALUES('$patname', '$queue_number', '$queue_date', '$status', '$service')");
